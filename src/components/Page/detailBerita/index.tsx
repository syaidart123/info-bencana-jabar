...
const DetailBeritaView = () => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto my-8 min-h-screen max-w-4xl p-4">
        <div className="mb-10">
          ...
          <div className="my-5 flex items-center justify-center">
            <div className="max-w-full overflow-hidden rounded-lg shadow-md hover:shadow-lg">
              <Image
                alt={data.title}
                src={data.image}
                loading="lazy"
          ...
          <div className="prose lg:prose-lg mx-auto max-w-3xl break-words bg-white">
            {paragraphs}
          </div>
        </div>
      </div>
